...
def test_remove_shared_label_valid(setup_create_a_shared_label_for_remove, valid_token):
    response = remove_a_shared_label(json.dumps(setup_create_a_shared_label_for_remove), valid_token)
